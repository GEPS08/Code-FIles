...
bp = Piece('b', 'p', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\b_pawn.png')
wp = Piece('w', 'p', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\w_pawn.png')
bk = Piece('b', 'k', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\b_king.png')
wk = Piece('w', 'k', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\w_king.png')
br = Piece('b', 'r', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\b_rook.png')
wr = Piece('w', 'r', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\w_rook.png')
bb = Piece('b', 'b', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\b_bishop.png')
wb = Piece('w', 'b', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\w_bishop.png')
bq = Piece('b', 'q', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\b_queen.png')
wq = Piece('w', 'q', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\w_queen.png')
bkn = Piece('b', 'kn', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\b_knight.png')
wkn = Piece('w', 'kn', r'C:\Users\Joe\.vscode\code files\chess rip\pieces\w_knight.png')
...
def display_potential_moves(positions, grid):
    for i in positions:
        x, y = i
        WIN.blit(r'C:\Users\Joe\.vscode\code files\chess rip\pieces\w_king.png', (x,y))
